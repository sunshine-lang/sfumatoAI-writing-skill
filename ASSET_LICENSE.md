...
images in
[`skills/sfumatoai-writing-skill/assets/ip/LICENSE.txt`](skills/sfumatoai-writing-skill/assets/ip/LICENSE.txt).
Keeping the terms with the files ensures that they remain available when only
the Skill directory is installed.
